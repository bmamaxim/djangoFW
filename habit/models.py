...
class Habit(models.Model):
    ...
    publication_sign = models.BooleanField(verbose_name="Признак публикации", help_text="Публикация привычки",
                                           default=False, **NULLABLE)
    associated_habit = models.ForeignKey('self', verbose_name="Связзанная привычка", help_text="Свяжите привычки",
                                         on_delete=models.SET_NULL, **NULLABLE)
    reward = models.CharField(max_length=500, verbose_name="Вознаграждение", help_text="Награда за выполнение привычки",
                              **NULLABLE)
    nice_habit = models.BooleanField(verbose_name="Приятная привычка", help_text="Выберите приятную привычку",
                                     default=False, **NULLABLE)
